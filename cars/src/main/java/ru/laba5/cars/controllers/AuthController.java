...
import ru.laba5.cars.pojo.JwtResponse;
import ru.laba5.cars.pojo.LoginRequest;
import ru.laba5.cars.pojo.MessageResponse;
import ru.laba5.cars.pojo.SignupRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> authUser(@RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt, userDetails.getId(), userDetails.getUsername(),
                userDetails.getEmail(), userDetails.getVisits(), userDetails.getImage(), roles));
    }
